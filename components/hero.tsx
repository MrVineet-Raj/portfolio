  ...
  return (
    <div className="w-full flex flex-col items-center border-b">
      <section
        id="home"
        ref={containerRef}
        className="relative min-h-[calc(100vh-10rem)] flex items-center justify-center overflow-hidden w-full max-w-[1400px] border-l border-r"
        style={
          {
      ...
      >
        <div className="container px-4 md:px-6 flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16 border-t border-b py-8">
          <div className="text-center">
            ...
            >
              I build modern, high-performance web and mobile applications with
              a focus on user experience and scalability.
            </motion.p>
