...
export default function About() {
  ...
  return (
    <div className="w-full flex flex-col items-center border-b">
      <section
        id="about"
        className="bg-muted/30 w-full max-w-[1400px] border-l border-r"
      >
        <div className="container ">
          <div className="flex flex-col items-center text-center  w-full border-b py-8">
            <motion.div
            ...
            >
              ...
              <p className="text-muted-foreground max-w-[800px] mx-auto">
                ...
                technologies, blockchain development, and AI-powered
                applications.
              </p>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 items-start">
            <motion.div
              ...
              className="border-r h-full  px-4 md:px-8 py-8"
            >
              <div>
            ...
            <motion.div
              ...
              className="space-y-6 py-8 px-4 md:px-8"
            >
              <div>
